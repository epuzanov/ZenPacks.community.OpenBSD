...
__doc__="""TemperatureSensorMap

TemperatureSensorMap maps the sensorTable table to temperaturesensors objects
...
class TemperatureSensorMap(SnmpPlugin):
